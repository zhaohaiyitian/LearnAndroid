...
public class ExecutorManager {
    ...
    private static int CORE_POLL_SIZE = Math.max(2,Math.min(CPU_COUNT - 1, 5));
    private static int MAX_POOL_SIZE = CORE_POLL_SIZE;
    private static long KEEP_ALIVE_TIME = 5L;

    static {
        cpuExecutor = new ThreadPoolExecutor(CORE_POLL_SIZE,MAX_POOL_SIZE,KEEP_ALIVE_TIME, TimeUnit.SECONDS,
